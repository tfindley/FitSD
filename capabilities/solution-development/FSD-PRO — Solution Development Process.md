...
**Idea Brief.** The optional one-page intake (FSD-FRM-00) raised before Gate 1 to decide whether an idea is worth a proper look. It sets out how things are, what's wrong with that and what it risks, the questions raised and their answers, with every answer stated as an outcome. It carries forward into Gate 1 and designs nothing.
